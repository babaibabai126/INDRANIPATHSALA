...
const FAQS: QA[] = [
  ...
  },
  {
    ...
    a:
      "হ্যাঁ, অবশ্যই। নোটটি অত্যন্ত সহজ ও সরল ভাষায় লেখা, যাতে যে কোনো স্টুডেন্ট সহজে বুঝতে পারে। বিগত কয়েক বছরের পরীক্ষার ট্রেন্ড অ্যানালিসিস করে এবং গুরুত্বপূর্ণ প্রশ্নগুলোকে ফোকাস করে এটি তৈরি করা হয়েছে, যা আপনার ফাইনাল পরীক্ষার প্রস্তুতিতে ১০০% মজবুত করবে।",
  },
  {
