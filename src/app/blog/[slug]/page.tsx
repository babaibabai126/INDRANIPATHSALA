...
import { ArrowLeft, Clock, BookOpen, Calendar, Tag } from "lucide-react";
...
// (Same data as in /blog/page.tsx — duplicate intentionally for SSR access)
const POSTS: BlogPost[] = [
  {
    slug: "d-pharm-exit-exam-complete-guide",
    title: "D.Pharm Exit Exam 2026: সম্পূর্ণ গাইড — সিলেবাস থেকে প্রস্তুতি পর্যন্ত",
    excerpt: "PCI-এর নতুন Exit Exam প্যাটার্ন, সিলেবাস বিশ্লেষণ, প্রশ্ন প্যাটার্ন, এবং কীভাবে প্রথম বারেই পাশ করবেন তার সম্পূর্ণ গাইড।",
    date: "2026-09-24",
    readTime: "8 min",
    category: "Exit Exam",
    content: [
  ...
  },
  {
    ...
    excerpt: "Pharmacy Council of India-এর ER-2020 সিলেবাসের প্রতিটি chapter বিশদভাবে ব্যাখ্যা করা হয়েছে — কোন chapter থেকে কত নম্বর আসবে।",
    date: "2026-09-22",
    readTime: "6 min",
    category: "Syllabus",
    content: [
      ...
      "বাংলা মাধ্যমের ছাত্রছাত্রীদের জন্য ইংরেজি টার্মগুলো বুঝতে অসুবিধা হতে পারে। তাই আমাদের Combo Notes-ে প্রতিটি chapter-এর বাংলা translation সাথে দেওয়া হয়েছে।",
    ],
  },
  {
    slug: "best-d-pharm-notes-bengali",
    title: "D.Pharm বাংলা নোটস — কেন বাংলা translation প্রস্তুতিতে সাহায্য করে",
    excerpt: "বাংলা মাধ্যমের ছাত্রছাত্রীদের জন্য D.Pharm বাংলা নোটস কেন জরুরি এবং কীভাবে এটি আপনার রেজাল্ট উন্নত করতে সাহায্য করে।",
    date: "2026-09-20",
    readTime: "5 min",
    category: "Study Tips",
    content: [
      ...
      "আমাদের Combo Notes-ে প্রতিটি chapter-এর ইংরেজি ব্যাখ্যার পাশে বাংলা translation দেওয়া আছে। এতে ছাত্রছাত্রীরা দ্রুত বুঝতে পারে এবং দীর্ঘস্থায়ী স্মৃতিতে সংরক্ষণ করতে পারে।",
  ...
  },
  {
    ...
    excerpt: "D.Pharm পরীক্ষায় MCQ প্রশ্নের সঠিক উত্তর দেওয়ার কৌশল — কীভাবে সময় বাঁচাবেন এবং ভুল কম করবেন।",
    date: "2026-09-18",
    readTime: "4 min",
    category: "Exam Tips",
    content: [
  ...
  },
  {
    ...
    excerpt: "Pharmaceutics-এর প্রতিটি chapter-এর সংক্ষিপ্ত সারাংশ যা পরীক্ষার আগে রিভিশনের জন্য দারুণ কাজে দেবে।",
    date: "2026-09-16",
    readTime: "7 min",
    ...
    content: [
      ...
      "আমাদের Notes-ে প্রতিটি chapter-এর সারাংশ ১-২ পৃষ্ঠায় দেওয়া আছে। পরীক্ষার আগের রাতে শুধু এই summaries পড়লেই মূল পয়েন্টগুলো মনে পড়ে যাবে।",
    ],
  },
  {
    slug: "pharmacology-made-easy-bengali",
    title: "Pharmacology বাংলায় সহজ করে — 2nd Year প্রস্তুতির সম্পূর্ণ গাইড",
    excerpt: "Pharmacology-এর জটিল টপিকগুলো বাংলায় সহজ ভাষায় ব্যাখ্যা করা হয়েছে — drug classification থেকে drug interaction পর্যন্ত।",
    date: "2026-09-14",
    readTime: "9 min",
    category: "Subject Notes",
    content: [
      ...
      "আমাদের Pharmacology Combo Notes-ে প্রতিটি drug class-এর বাংলা ব্যাখ্যা সহ টেবিল চার্ট দেওয়া আছে। এটি আপনার প্রস্তুতিকে অনেক সহজ করবে।",
    ],
  },
  {
    slug: "year-back-students-strategy",
    title: "Year-Back Students-এর জন্য বিশেষ কৌশল — কীভাবে পরীক্ষায় পাশ করবেন",
    excerpt: "Year-back পড়া ছাত্রছাত্রীদের জন্য বিশেষ প্রস্তুতি পদ্ধতি — আত্মবিশ্বাস ফেরানোর উপায় এবং পড়ার কৌশল।",
    date: "2026-09-12",
    readTime: "6 min",
    category: "Motivation",
    content: [
  ...
  },
  {
    ...
    excerpt: "D.Pharm এবং B.Pharm-এর মধ্যে পার্থক্য — কোর্স সময়, খরচ, ক্যারিয়ার সুযোগ এবং কোনটি কখন বেছে নেবেন।",
    date: "2026-09-10",
    readTime: "5 min",
    category: "Career",
    content: [
  ...
  },
  {
    ...
    excerpt: "পরীক্ষার আগের সপ্তাহে কীভাবে smart revision করবেন যাতে সব মনে থাকে — প্রমাণিত পদ্ধতি।",
    date: "2026-09-08",
    readTime: "5 min",
    category: "Study Tips",
    content: [
      ...
      "Chapter-wise Summary ব্যবহার করুন। সম্পূর্ণ chapter আবার পড়ার সময় নেই — শুধু মূল পয়েন্টগুলো ঝালিয়ে নিন। আমাদের Notes-ে প্রতিটি chapter-এর summary আছে যা দ্রুত রিভিশনের জন্য পারফেক্ট।",
  ...
  },
  {
    ...
    excerpt: "D.Pharm পাশ করার পর কোথায় কোথায় কাজ পাবেন, বেতন কেমন হবে, এবং কীভাবে ক্যারিয়ার গড়বেন।",
    date: "2026-09-06",
    readTime: "6 min",
    category: "Career",
    content: [
  ...
  },
  {
    ...
    excerpt: "Tablet এবং capsule কীভাবে তৈরি হয়, কী উপাদান লাগে, manufacturing process — সব বিস্তারিত।",
    date: "2026-09-04",
    readTime: "7 min",
    category: "Pharmaceutics",
    content: [
      "Tablet এবং capsule হলো সবচেয়ে জনপ্রিয় dosage form। এগুলি সহজে বহন করা যায়, সঠিক ডোজ দেওয়া যায়, এবং shelf life বেশি। Pharmaceutics-ে এই টপিকটি থেকে প্রতি বছর প্রশ্ন আসে।",
      "Tablet Formulation-ে মূল উপাদানগুলো হলো: Active Pharmaceutical Ingredient (API), Diluent (যেমন lactose), Binder (যেমন starch), Disintegrant (যেমন croscarmellose), Lubricant (যেমন magnesium stearate), এবং Glidant।",
      "Tablet Manufacturing Process: প্রথমে সব উপাদান ওজন করা হয়, তারপর mixing, granulation (wet বা dry), drying, screening, এবং tablet compression machine-ে চাপ দিয়ে tablet তৈরি করা হয়।",
      ...
      "আমাদের Pharmaceutics Notes-ে এই সব টপিকের বিস্তারিত ব্যাখ্যা সহ diagram দেওয়া আছে। বাংলা translation সহ বুঝতে সুবিধা হবে।",
    ],
  },
  {
    slug: "drug-interactions-clinical-pharmacy",
    title: "Drug Interactions — ক্লিনিকাল ফার্মেসিতে গুরুত্ব ও প্রকারভেদ",
    excerpt: "Drug-drug interaction, drug-food interaction কী, কেন জানা জরুরি, এবং কীভাবে রোগীকে কাউন্সেল করবেন।",
    date: "2026-09-02",
    readTime: "6 min",
    ...
    content: [
      ...
      "Mechanism: Pharmacokinetic interaction (ADME-তে প্রভাব) এবং Pharmacodynamic interaction (একই receptor বা pathway-তে প্রভাব)। CYP450 enzyme-ের inhibition বা induction সবচেয়ে সাধারণ কারণ।",
      ...
      "আমাদের Combo Notes-ে drug interaction-এর সবচেয়ে গুরুত্বপূর্ণ combinations একটি টেবিলে দেওয়া আছে। পরীক্ষায় এবং ক্লিনিকাল প্র্যাকটিসে দুটোতেই কাজে দেবে।",
    ],
  },
  {
    slug: "anatomy-physiology-d-pharm",
    title: "Human Anatomy & Physiology — D.Pharm 1st Year সহজ প্রস্তুতি",
    excerpt: "মানব দেহতত্ত্ব ও শারীরবিদ্যা — সব সিস্টেম সহজ বাংলায় ব্যাখ্যা করা হয়েছে।",
    date: "2026-08-30",
    readTime: "8 min",
    category: "Anatomy",
    content: [
      ...
      "বাংলা translation সহ পড়লে জটিল টার্ম যেমন 'diastole', 'synapse', 'peristalsis' সহজে বোঝা যায়। আমাদের Combo Notes-ে প্রতিটি সিস্টেমের বাংলা ব্যাখ্যা দেওয়া আছে।",
    ],
  },
  {
    slug: "pharmacognosy-herbal-medicine",
    title: "Pharmacognosy — ভেষজ ওষুধ সম্পর্কে সম্পূর্ণ ধারণা",
    excerpt: "Pharmacognosy বা ভেষজ ওষুধ বিজ্ঞান — গুরুত্বপূর্ণ chapter, কী কী পড়বেন, এবং পরীক্ষায় কীভাবে ভালো করবেন।",
    date: "2026-08-28",
    readTime: "5 min",
    category: "Pharmacognosy",
    content: [
      "Pharmacognosy হলো প্রাকৃতিক উৎস থেকে প্রাপ্ত ওষুধের অধ্যয়ন — মূলত উদ্ভিদ, প্রাণী ও খনিজ উৎস। এটি D.Pharm 1st Year-ের একটি আকর্ষণীয় বিষয়।",
      ...
      "Indian Pharmacopoeia-ে উল্লেখিত ভেষজ ওষুধগুলো বিশেষভাবে পড়ুন। কারণ পরীক্ষায় সাধারণত এগুলো থেকেই প্রশ্ন আসে।",
      "Pharmacognosy-তে ভালো করতে হলে মনে রাখার কৌশল দরকার — mnemonic, diagram, এবং chart ব্যবহার করুন। আমাদের Notes-ে প্রতিটি ভেষজ ওষুধের ছবি, নাম, ব্যবহার একটি টেবিলে সাজানো আছে।",
    ],
  },
];
...
export function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  return {
    title: `${post.title} | Indrani Pathsala Blog`,
    ...
    <main className="flex min-h-screen flex-col bg-background">
      ...
      <header className="border-b border-border bg-background/85 backdrop-blur-lg">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-4 sm:px-6">
          <Link href="/blog" className="flex items-center gap-2 text-sm font-semibold text-foreground hover:text-primary">
            <ArrowLeft className="h-4 w-4" />
            <span className="bn">সব ব্লগ পোস্ট</span>
          </Link>
      ...
      <article className="mx-auto w-full max-w-3xl flex-1 px-4 py-10 sm:px-6">
        ...
        <header>
          <div className="flex flex-wrap items-center gap-3 text-[11px] font-bold uppercase tracking-wider">
            <span className="inline-flex items-center gap-1 rounded-full bg-primary/15 px-2.5 py-1 text-primary">
          ...
          <h1 className="bn mt-4 text-3xl font-extrabold leading-tight text-foreground sm:text-4xl">
            {post.title}
          </h1>
          <p className="bn mt-3 text-[15px] leading-relaxed text-muted-foreground">
            {post.excerpt}
          </p>
        </header>
        ...
        <div className="mt-8 space-y-5">
          {post.content.map((para, i) => (
            <p
              key={i}
              className="bn text-[15px] leading-[1.85] text-foreground/90 sm:text-base"
            >
              {para}
            </p>
          ))}
        ...
        <div className="mt-12 rounded-2xl border border-border bg-card p-6 text-center">
          <h3 className="bn text-lg font-bold text-foreground">
            প্রিমিয়াম সাজেস্টিভ নোটস কিনুন
          </h3>
          <p className="bn mt-2 text-[13px] text-muted-foreground">
            PCI ER-2020 সিলেবাস অনুযায়ী তৈরি, বাংলা translation সহ, শুধু ₹999 থেকে শুরু।
          </p>
          <Link
            href="/#pricing"
            className="glow-amber mt-4 inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2.5 text-sm font-bold text-primary-foreground transition hover:opacity-90"
          >
            BUY NOW →
          </Link>
        </div>
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
              {related.map((r) => (
                <Link
                  key={r.slug}
                  href={`/blog/${r.slug}`}
                  className="group rounded-xl border border-border bg-card p-4 transition hover:border-primary/40 hover:shadow-lg"
                >
                  <div className="text-[10px] font-bold uppercase tracking-wider text-primary">
                    {r.category}
                  </div>
                  <h4 className="bn mt-1.5 text-[13px] font-semibold leading-snug text-foreground group-hover:text-primary">
                    {r.title}
                  </h4>
                </Link>
              ))}
